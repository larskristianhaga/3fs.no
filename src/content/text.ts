export const siteText = {
    ...
    home: {
        hero: {
            ...
            description: 'Treet står vrient til? Vi håndterer de vanskeligste trefelling-jobber. Gratis befaring, ingen overraskelser i prisen.',
        ...
        whyChooseUs: {
            ...
            experience: {
                ...
                description: 'Vår erfarne klatrer har mer enn 15 års erfaring med klatring og trefelling av vanskelige trær.',
            },
            insured: {
                title: 'Fullt forsikret',
                description: 'Vi har full ansvarsforsikring som dekker eventuelle skader. Trygghet for deg som kunde.',
            },
            fast: {
                title: 'Raskt og effektivt',
                description: 'Med moderne utstyr og erfarne fagfolk leverer vi raske og effektive løsninger.',
            },
            competitive: {
                title: 'Konkurransedyktige priser',
                description: 'Gratis befaring og uforpliktende pristilbud. Vi gir deg en rettferdig pris for jobben.',
            },
        },
        ourStory: {
            title: 'Vår historie',
        ...
        servicesSection: {
            ...
            treeFelling: {
                title: 'Trefelling',
                description: 'Vi utfører felling av alle typer trær, både små og store. Med erfarne fagfolk og riktig utstyr håndterer vi selv de mest utfordrende situasjoner.',
                linkText: 'Les mer →',
            },
            stumpGrinding: {
                title: 'Stubbefresing',
                description: 'Den mest skånsomme og effektive måten å fjerne stubber på. Vi freser ca. 20-30 cm under bakken for å fjerne alle spor.',
                linkText: 'Les mer →',
            },
            pruning: {
                title: 'Beskjæring',
                description: 'Store trær kan beskjæres, reduseres, formes eller toppes. Våre dyktige trefellere har gjennomført beskjæringskurs.',
                linkText: 'Les mer →',
            },
            siteClearance: {
                title: 'Tomterydding',
                description: 'Vi har alt vi trenger for å effektivt klargjøre og rydde en eiendom for trær, busker og annen vegetasjon.',
                linkText: 'Les mer →',
            },
            chipping: {
                title: 'Flishugging',
                description: 'Miljøvennlig og effektiv måte å rydde kvist, greiner og mindre trestammer på. Flisen egner seg godt som dekkbark.',
                linkText: 'Les mer →',
            },
            removal: {
                title: 'Bortkjøring',
                description: 'Vi hjelper gjerne med bortkjøring av flis, greiner og trestammer etter gjennomført arbeid.',
                linkText: 'Les mer →',
            },
    ...
    about: {
        ...
        intro: [
            {
                paragraph: 'Trefellingsspesialisten holder til i Ås kommune, og vi tar på oss oppdrag i Oslo, Akershus, Østfold og store deler av Buskerud. Vi tilbyr alt innen trefelling, beskjæring, stubbefresing, flishugging, bortkjøring og oppryddning. Vi har oppdrag for stat og kommune, bedrifter og borettslag, privat- og ferie eiendommer. Vi tilbyr alltid en gratis befaring og uforpliktende pristilbud.',
            },
            {
                paragraph: 'Med erfarne fagfolk og korrekt utstyr feller og beskjærer vi alle typer trær på en skånsom og sikker måte. Vår erfaren klatrer med mer enn 15 års erfaring, er vant med å håndtere utfordrende situasjoner i høyden og har spesialutstyr for å ta ned spesielt vanskelige trær. Så trær som står litt vrient til i hagen, inneklemt mellom hus, ledningsnett, veier eller andre hindringer er ikke noe problem, vi tar jobben!',
            },
            {
                paragraph: 'Ingen oppdrag er for store eller små. Vi hjelper deg med akkurat den delen av jobben som du ikke får til eller ønsker å gjøre selv. Når jobben er ferdig sørger vi alltid for å rydde opp, og forlater stedet like fint som vi fant det.',
            }
    ...
    contact: {
        ...
        form: {
            ...
            message: 'Melding',
            attachment: 'Vedlegg',
            attachmentHint: 'Du kan legge ved flere bilder. Maks 4 MB til sammen.',
            required: '*',
    ...
    blog: {
        title: 'Blogg',
        subtitle: 'Tips, råd og innsikt om trefelling og trepleie',
        posts: [
            {
                id: 'treet-er-syk',
...
Ikke venter for lenge - syke trær kan bli farlige. Ta kontakt med oss i dag!`,
                ...
                imageAlt: 'Syk tre som trenger vurdering',
            },
            {
...
Kontakt oss i dag for en gratis befaring og exactt pristilbud!`,
                ...
                imageAlt: 'Trefelling kostnad guide',
            },
            {
...
Kontakt oss i dag for en gratis og sikker befaring!`,
                ...
                imageAlt: 'Sikker trefelling med profesjonelt utstyr',
            },
            {
...
Kontakt oss tidlig. Vi kan planlegge jobben din for optimal timing!`,
                ...
                imageAlt: 'Sesongbest trefelling planlegging',
            },
            {
